...
void Domoaster::InitConnectors() {
    ...
    for (Kernel::ConnectorList::iterator it = l.begin(); it != l.end();) {
        IConnector *c = *it;
    ...
    DOMOASTER_INFO << "InitConnectors : " << l.size() << " connectors initialized";
}

void Domoaster::InitProtocols() {
    Kernel::ProtocolList & l = _kernel.Protocols();
    DOMOASTER_INFO << "InitProtocols : " << l.size() << " protocols found";
    for (Kernel::ProtocolList::iterator it = l.begin(); it != l.end();) {
        IProtocol *pt = *it;
    ...
    DOMOASTER_INFO << "InitProtocols : " << l.size() << " protocols initialized";
}

void Domoaster::InitNodes() {
    Kernel::NodeList & l = _kernel.Nodes();
    DOMOASTER_INFO << "InitNodes : " << l.size() << " nodes found";
    for (Kernel::NodeList::iterator it = l.begin(); it != l.end();) {
        INode *n = *it;
    ...
    DOMOASTER_INFO << "InitNodes : " << l.size() << " nodes initialized";
}
